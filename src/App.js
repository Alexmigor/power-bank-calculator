    ...
    <div className="App">
      <main className="App-main">
        ...
        <div className='all-power' >
          ...
          <p className='left'>Якщо на вашому пристрої вказана потужність не у Ватах, а у Вольтах (V) та Амперах (A) - скористайтеся розділом вище, щоб перевести їх у Вати (W).
            <br />
