    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className='power' >
          ...
          <i>V</i> = <input value={volt} type="number" onChange={e => setVolt(e.target.value)} /> <i>A</i> =  <input value={amper} type="number" onChange={e => setAmper(e.target.value)} /> Вт = <span className='green'>{result}</span>

        </div>

        <div className='all-power' >
          <h3>Определить общую мощность всех устройств</h3>
          <p >Если на вашем устройстве указана мощность не в Ваттах, а в Вольтах (V) и Амперах (A) - воспользуйтесь разделом выше, чтобы перевести их в Ватты.
          ...
          <p >Номинальная мощность вашего инвертора должна быть больше вышеуказанного значения.</p>

        </div>

        <div className='accum-bat' >
          <h3>Расчитать емкость АКБ (12 V)</h3>
          <p>Укажите желаемое время работы повербанка</p>
          ...
          <p>Автомобильные аккумуляторы нельзя разряжать полностью!<br /> Остаточная ёмкость его должна составлять не менее 25-30%.<br /> Поэтому, с поправкой на коэффициент, для данной системы необходим аккумулятор(ры) общей емкостью не менее <span>{alllll}</span> Ah.</p>
        </div>
